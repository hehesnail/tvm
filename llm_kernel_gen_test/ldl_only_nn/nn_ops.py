...
@auto_scheduler.register_workload
def add(N,C,H,W):
    data_a = te.placeholder((N,C,H,W), name='data',dtype="float32")
    data_b = te.placeholder((N,C,H,W), name='data',dtype="float32")
...
success_count = 0
failure_count = 0
c_path    = "generate/nn_c/"
cuda_path = "generate/nn_cuda/"
...
#这里仅尝试 add 一项NCHW算子的测试流程
list_nchw_random = [add]
