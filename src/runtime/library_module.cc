...
PackedFunc WrapPackedFunc(TVMBackendPackedCFunc faddr, const ObjectPtr<Object>& sptr_to_self) {
  return PackedFunc([faddr, sptr_to_self](TVMArgs args, TVMRetValue* rv) {
    ...
    // std::cout << "~~~~~~~~~~~~faddr func exec call ???? ---> operator()?\n";
    ...
    // std::cout << "~~~~~~~~~~~~faddr func exec fin:   " << ret << ", " << ret_type_code << "\n";
    // comment this check, cext module ret -1, may caused by llvm host check???. @hxf
